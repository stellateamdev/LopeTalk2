...
class KACircleCropViewController: UIViewController, UIScrollViewDelegate {
    ...
    func setLabelAndButtonFrames() {
        ...
        label.frame.origin = CGPoint(x: cutterView.frame.size.width/2 - label.frame.size.width/2, y: cutterView.frame.size.height/2 - view.frame.size.height/2 + 15 + (UIDevice.iPhoneX ? 15:0))
        
        okButton.frame.origin = CGPoint(x: cutterView.frame.size.width/2 + view.frame.size.width/2 - okButton.frame.size.width - 12, y: cutterView.frame.size.height/2 - view.frame.size.height/2 + 15 + (UIDevice.iPhoneX ? 15:0))
        
        backButton.frame.origin = CGPoint(x: cutterView.frame.size.width/2 - view.frame.size.width/2 + 3, y: cutterView.frame.size.height/2 - view.frame.size.height/2 + 15 + (UIDevice.iPhoneX ? 15:0))
