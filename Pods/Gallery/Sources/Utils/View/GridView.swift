...
class GridView: UIView {
  ...
  func setup() {
    backgroundColor = UIColor.white//lightGray.withAlphaComponent(0.5)
    ...
    topView.g_pinUpwardCustom()
    topView.g_pin(height: 40 + (UIDevice.iPhoneX ? 40:0))
    ...
    closeButton.g_pinCloseGalleryTop(on: .top)
    
    closeButton.g_pinCloseGallery(on: .left)
